 ...
 * *************************************************************
 */
package com.gt.zplutils.zpl.command;
...
public enum ZebraCommonCodes {
	...
	* */
	RECALL_FORMAT("XF",
			"Recall Format"),
	/**
	 * A matrix symbology consisting of an array of nominally square modules
	 * arranged in an overall square pattern. A unique pattern at three of the
	 * symbol’s four corners assists in determining bar code size, position, and
	 * inclination.
	 */
