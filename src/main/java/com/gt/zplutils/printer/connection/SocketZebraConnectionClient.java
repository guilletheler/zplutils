 ...
 * *************************************************************
 */
package com.gt.zplutils.printer.connection;
...
import com.gt.zplutils.listeners.ClientListener;
import com.gt.zplutils.listeners.DataListener;
...
public class SocketZebraConnectionClient implements ZebraConnectionClient {
	 ...
	 * @param port The port number on zebra printer that will accept the connection.
	 */
	...
	private void notifyFailConnect(final Exception e) {
		/*
		 * For each listener, create a separate independent thread for firing the
		 * listener methods.
		 */
